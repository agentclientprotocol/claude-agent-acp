...
When a patch has unsafe or unordered coordinates, inconsistent line counts, misplaced EOF markers,
or unsupported prefixes, the adapter omits the statistics.
