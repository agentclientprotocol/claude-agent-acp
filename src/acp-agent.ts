...
function sessionFailureMeta(failure: PublishedSessionFailure) {
  return {
    [JETBRAINS_META_KEY]: {
      [AIR_META_KEY]: {
...
function assistantMessageText(apiMessage: unknown): string | undefined {
...
function activeUsageLimitMessage(
